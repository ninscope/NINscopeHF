...
public void createGUI(){
  ...
  LbL_FrameBehave = new GLabel(this, 400, 390, 70, 20);
  ...
  Btn_FineGainCam1_Down = new GButton(this, 110, 580, 40, 20);
  Btn_FineGainCam1_Down.setText("<");
  Btn_FineGainCam1_Up = new GButton(this, 160, 580, 40, 20);
  ...
  Btn_FineGainCam2_Down = new GButton(this, 750, 540, 40, 20);
  Btn_FineGainCam2_Down.setText("<");
  Btn_FineGainCam2_Up = new GButton(this, 800, 540, 40, 20);
  Btn_FineGainCam2_Up.setText(">");
  Lbl_FrameRate = new GLabel(this, 190, 420, 30, 20);
  Lbl_FrameRate.setText("Fr:");
  Lbl_FrameRate.setTextBold();
  Lbl_FrameRate.setOpaque(false);
  Drpl_FrameRate = new GDropList(this, 230, 420, 60, 200, 9);
  Drpl_FrameRate.setItems(loadStrings("list_835327"), 0);
  Drpl_Cam1Format = new GDropList(this, 300, 420, 90, 200, 9);
  Drpl_Cam1Format.setItems(loadStrings("list_all_formats"), 0);
  ChkBox_Bin = new GCheckbox(this, 190, 440, 40, 20);
  ChkBox_Bin.setIconAlign(GAlign.LEFT, GAlign.MIDDLE);
  ChkBox_Bin.setText("Bin");
  ChkBox_Bin.setOpaque(false);
  Lbl_DataSize = new GLabel(this, 250, 50, 140, 20);
  Lbl_DataSize.setTextAlign(GAlign.RIGHT, GAlign.MIDDLE);
  Lbl_DataSize.setText("Data Size:752x480");
  Lbl_DataSize.setOpaque(false);
  Btn_HistoCam1 = new GButton(this, 340, 380, 50, 30);
  Btn_HistoCam1.setIcon("histo.png", 1, GAlign.NORTH, GAlign.CENTER, GAlign.TOP);
  Btn_HistoCam2 = new GButton(this, 1080, 380, 50, 30);
  Btn_HistoCam2.setIcon("histo.png", 1, GAlign.NORTH, GAlign.CENTER, GAlign.MIDDLE);
  WindowZoomCam1 = GWindow.getWindow(this, "Zoom Cam 1", 0, 0, 800, 650, JAVA2D);
  WindowZoomCam1.noLoop();
  Btn_CentreSLDCam1 = new GButton(WindowZoomCam1, 220, 510, 60, 30);
  Btn_CentreSLDCam1.setText("Centre");
  Lbl_ViewCam1 = new GLabel(WindowZoomCam1, 230, 490, 40, 20);
  ...
  SettingsWnd.noLoop();
  Btn_OKSettings = new GButton(SettingsWnd, 370, 560, 80, 30);
  ...
  LbL_FramesPT.setTextAlign(GAlign.RIGHT, GAlign.MIDDLE);
  ...
  Btn_CentreSLDCam2 = new GButton(WindowZoomCam2, 220, 510, 60, 30);
  Btn_CentreSLDCam2.setText("Centre");
  Lbl_ViewCam2 = new GLabel(WindowZoomCam2, 230, 490, 40, 20);
  ...
  LbL_warning = new GLabel(WindowWarning, 10, 10, 300, 50);
  LbL_warning.setTextAlign(GAlign.CENTER, GAlign.MIDDLE);
  LbL_warning.setText("---");
  LbL_warning.setTextBold();
  LbL_warning.setOpaque(false);
  HistogramCam1 = GWindow.getWindow(this, "Histogram Cam 1", 0, 0, 280, 130, JAVA2D);
  HistogramCam1.noLoop();
  HistogramCam2 = GWindow.getWindow(this, "Histogram Cam 2", 0, 0, 280, 130, JAVA2D);
  HistogramCam2.noLoop();
  WindowZoomCam1.loop();
  SettingsWnd.loop();
...
GLabel Lbl_FrameRate; 
GDropList Drpl_FrameRate; 
GDropList Drpl_Cam1Format; 
GCheckbox ChkBox_Bin; 
GLabel Lbl_DataSize; 
GButton Btn_HistoCam1; 
GButton Btn_HistoCam2; 
...
GButton Btn_Warning; 
GLabel LbL_warning; 
GWindow HistogramCam1;
GWindow HistogramCam2;
