...
public void TrigRecordingStr()
{
        if( fCam1Enabled )
        {
          ...
          if(HighFrameRate)
          {
                ...
                PWriteImageData = new RawRecording(sketchPath() + FilePrefix + "/ImageScope1.raw", cam.width , cam.height );
          }
...
public void serialEvent(Serial myPort) 
{
  ...
  if( read != null)
  {
    ...
    else if( SerialCmd == 'V')
    {
      ...
      surface.setTitle("NINscope v" + MAJOR + "." + MINOR + StrVersion + " FW v" + VersionCAM1  );
    }
  }
}
