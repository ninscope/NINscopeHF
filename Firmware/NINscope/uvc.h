...
////////////////////////////////////
///////////////////////////////////
#define CY_FX_EP_PRODUCER               0x04                             /* EP 2 OUT */
#define CY_FX_EP_CONSUMER               0x84                             /* EP 2 IN */
...
#define CY_FX_UART_CMD_EVENT                  			(1 << 0)
#define CY_FX_UART_GSENS_DATA_EVENT                 	(1 << 1)
#define CY_FX_UART_TEMP_DATA_EVENT		            	(1 << 2)
...
#define CMD_EXCITATION		0x04
#define CMD_START_RECORD	0x05
#define CMD_SETTINGS		0x06
#define CMD_GAIN			0x07
#define CMD_FOCUS 			0x08
#define CMD_STIMULATE		0x09
#define CMD_TEMP_RD			0x0A
#define CMD_STOP_RECORD		0x0B
#define CMD_TRIG_ON			0x0C
#define CMD_TRIG_OFF		0x0D
#define CMD_GSENSOR_OFF		0x0E
#define CMD_ROI				0x0F
#define CMD_AGAIN			0x10
...
#define CMD_RESET_FRAME		0x19
#define CMD_PYTHON			201
